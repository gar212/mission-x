...
import './TeacherProjectBuilder2.css';
...
import LftArrow from'./img/LftArrow.png';
import Join from'./img/Join.png';
import RghtArrow from'./img/RghtArrow.png';
    ...
    return (
        ...
        {/* The code thats written between this comment and the one below are the switchable componets found in Teachers Submission. */}
          <div className='TeacherProjectsComp2'>
            <h4 className='h4JS'>1. JOIN SCRATCH</h4>
            <p className='pJS'>If you haven't used Scratch before, you will need to join Scratch first.<br />
                  Go to https://scratch.mit.edu. Click on <font color='#F91C85' font-family='Open Sans'>Join Scratch</font>  </p>
                <img className='LftArrow' src={ LftArrow } alt='LftArrow'/>
                <img className='Join' src={ Join } alt='Join'/>
                <img className='RghtArrow' src={ RghtArrow } alt='RghtArrow'/>
                <p className='p1JS'>Follow the instructions to join. You will need a username and a password that you will remember. If possible, you <br />
                      should also verify your email address so that you can Share projects later. Ask your teacher to help with this step if<br />
                      you don't have an email address, or if you are not sure what to do.
                </p>
